...
class managerUserOld implements managerUserInterface
{
    ...
    public function add(user $user): int
    {
        ...
        $result = adapterUser::add($this->db, [$user]);

        // if result is an empty array an error happened at adapter level
        if ($result == null)
    ...
    public function remove(user $user): int
    {
        ...
        adapterUser::remove($this->db, [$user_db]);
    ...
    public function edit(user $userOld, user $userNew): int
    {
        ...
        adapterUser::edit($this->db, [$userNew]);
    ...
    {
        $users = adapterUser::search($this->db, null, $name);
    ...
    {
        $users = adapterUser::search($this->db, $id);
