...
/**
 * Script used for internal testing of users
 * 
...
require_once("db/adapter/db_adapter_user.php");
...
// echo json_encode(adapterUser::search($db, 2));

// search for user by name
// echo json_encode(adapterUser::search($db, null, "andreas"));
